...
<link href="h/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
 ...
 <link href="success/style1.css" rel="stylesheet"  type="text/css" media="all" />
<link href="success/style.css" rel="stylesheet" type="text/css" media="all" />
...
<link href="//fonts.googleapis.com/css?family=Tangerine:400,700" rel="stylesheet"/>
    ...
    <link href="register/registration/sweetalert.css" rel="stylesheet" />
    <link href="success/logoutbar.css" rel="stylesheet" />
...
<body>
	...
	<a href="Product.aspx" class="dropdown-toggle menu__link">Product</a>
      ...
      <a href="#" class="dropdown-toggle menu__link"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Division<span class="caret"></span></a>
						...
						<ul class="dropdown-menu">
							<li><a href="Dhaka.aspx">Dhaka</a></li>
						   <li><a href="Chittagong.aspx">Chittagong</a></li>
     ...
     <div id="usr">
       <!-- User Icon  -->
        ...
        <img runat="server"  id="Image1" class="img_thumb" src="User_image" />
                       
  <h3 class="Un"><asp:Label ID="LabelUN" runat="server" Text="User Name"></asp:Label>
 ...
 <div id="usrr" class="CP_Head_Usr_Pan">
   <div class="CP_Head_Pan_topdiv">
     <center>  
       <!-- User Image  -->
          <img runat="server"  id="Image2"  src="User_image" />
     <h5><asp:Label ID="LabelEM" runat="server" Text="User Email"></asp:Label></h5>
    </center>
  </div>
