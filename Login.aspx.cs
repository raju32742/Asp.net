...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void ButtonLogin_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        string checkuser = "select count(*) from UserInfm where UserName='" + TextBoxUNLogin.Text + "'";
        ...
        {
            conn.Open();
            string checkPasswordQuery = "select Password from UserInfm where UserName='" + TextBoxUNLogin.Text + "'";
