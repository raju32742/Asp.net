<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chittagong.aspx.cs" Inherits="Chittagong" %>
...
<body>
	...
	<div class="container"> 
		<ol class="breadcrumb breadcrumb1">
			...
			<li><a href="Product.aspx">Product Menu</a></li>
			<li class="active">Location : Chittagong</li>
		</ol> 
		<div class="clearfix"> </div>
	</div>
	<!-- //breadcrumbs -->
...
<div class="main">
        ...
        <fieldset>
         <div class="filter">          
            <asp:DropDownList ID="product" runat="server" CssClass="filterD" Width="200px">
                <asp:ListItem Text="Filterd by"  Value="0"></asp:ListItem>
                <asp:ListItem Text="Recent Product" Value="1"></asp:ListItem>
                <asp:ListItem Text="Lowest Price" Value="2"></asp:ListItem>
                 <asp:ListItem Text="Hightest Price" Value="3"></asp:ListItem>
            </asp:DropDownList>
            
                <asp:Button ID="btnSubmit" runat="server" CssClass="filterB"
                    Text="Click to Retrieve Value" onclick="btnSubmit_Click" />            
            </div>
...
<asp:Panel ID="PanelSearch" runat="server" CssClass="PanelS" DefaultButton="ButtonSearch">
